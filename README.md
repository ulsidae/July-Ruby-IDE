...
The project was started in June, but named “July Ruby IDE”.
This name comes from Ruby, the birthstone of July.
...
This project is intentionally lightweight. By rethinking code execution as an observable process rather than a hidden one.
(Therefore, it does not support Ruby gems.)

It is not a full IDE like VSCode or RubyMine.
Instead, it is designed as a learning playground where code execution and editing logic are made visible and simple.
...
Built by ulsidae.
A small experimental step into building developer tools from scratch.
